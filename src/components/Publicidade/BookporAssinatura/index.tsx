...
import FotoBookPorAssinatura from'../../../assets/FotoBookPorAssinatura.jpg'
import { useNavigation } from "@react-navigation/native";

export const BookPorAssinatura = () => {
    ...
    <Container>
      ...
      <Poste>
        <TouchableOpacity onPress={() => setModalVisible(true)}>
          <ImagePost source={FotoBookPorAssinatura} resizeMode="cover" />
        </TouchableOpacity>
      </Poste>
