...
import FotoPostagemCasamentoArLivre from '../../../assets/FotoPostagemCasamentoArLivre.png';
import { useNavigation } from "@react-navigation/native";

export const CasamentoArLivre = () => {
    ...
    <Container>
      ...
      <Poste>
        <TouchableOpacity onPress={() => setModalVisible(true)}>
          <ImagePost source={FotoPostagemCasamentoArLivre} resizeMode="cover" />
        </TouchableOpacity>
      </Poste>
